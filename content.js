...
const CONTENT = {
  ...
  nl: {
    ...
    builder: {
      ...
      label: "Gemaakt door één persoon in Nederland",
    },
    pain: {
      ...
      cards: [
        { t: "Tijd", d: "Het portaal van de Belastingdienst kost je een middag als je de regels niet kent. Dat zou niet zo moeten zijn." },
        { t: "Taal", d: "Het formulier is in het Nederlands. Je facturen zijn in het Engels. Je tools zijn Amerikaans. Eén van deze dingen hoort niet in het rijtje." },
        { t: "Onwetendheid", d: "Reverse charge. Rubriek 4a. ICP-opgaaf. Niemand legt het uit als je je KVK registreert. Je ontdekt het pas als er iets misgaat." },
        { t: "Angst", d: "Een verkeerde rubriek is niet zomaar een foutje — het is een brief van de Belastingdienst. De meeste zzp'ers doen het goed. De meesten weten het alleen niet zeker." },
      ],
    ...
    audience: {
      ...
      h: "Herken je dit?",
      cards: [
        { d: "Je gebruikt Vercel, Anthropic, Linear. Al je kosten zijn buitenlandse facturen zonder BTW. Je wist niet dat dat 'reverse charge' heet — en dat jij de BTW zelf moet aangeven." },
        { d: "Je woont in Nederland maar denkt in het Engels. Het Belastingdienst-portaal is in het Nederlands. Elk kwartaal open je Google Translate naast het formulier." },
        { d: "Je houdt alles bij in een Excel. Het werkt min of meer. Maar elke aangifte vraag je je af: doe ik dit goed?" },
        { d: "Je boekhouder rekent €200 per kwartaal voor je BTW. Voor vijf facturen. Ergens voelt dat niet kloppen." },
      ],
    },
    compare: {
    ...
    footer: {
      tagline: "Je facturen erin. {agent}.",
      madeBy: "Gemaakt door Gabz in Groningen, NL",
      linksH: "Links",
      legalH: "Legal",
      contact: "hello@{domain}",
      legal: ["Voorwaarden", "Privacybeleid", "Cookiebeleid", "Disclaimer"],
      soon: "Beschikbaar bij lancering",
      barLeft: "© {year} {brand}. Alle rechten voorbehouden.",
      barRight: "{brand} · Niet verbonden aan de Belastingdienst · Preview-prototype",
  ...
  en: {
    ...
    builder: {
      ...
      sig: "— Gabz, zzp'er & maker",
      label: "Made by one person in the Netherlands",
    },
    pain: {
      eyebrow: "The problem",
      ...
      cards: [
        { t: "Time", d: "The Belastingdienst portal takes an afternoon if you don't know the rules. It shouldn't." },
        { t: "Language", d: "The form is in Dutch. Your invoices are in English. Your tools are American. One of these things is not like the others." },
        { t: "Not knowing", d: "Reverse charge. Rubriek 4a. ICP opgaaf. Nobody explains these when you register your KVK. You find out when something goes wrong." },
        { t: "The fear", d: "A wrong rubriek isn't just a mistake — it's a letter from the Belastingdienst. Most zzp'ers get it right. Most aren't sure they did." },
      ],
    ...
    audience: {
      ...
      h: "Sound familiar?",
      cards: [
        { d: "You use Vercel, Anthropic, Linear. All your costs are foreign invoices without BTW. You didn't know that's called 'reverse charge' — or that you have to declare the BTW yourself." },
        { d: "You live in the Netherlands but think in English. The Belastingdienst portal is in Dutch. Every quarter you open Google Translate next to the form." },
        { d: "You track everything in an Excel. It more or less works. But every aangifte you wonder: am I doing this right?" },
        { d: "Your accountant charges €200 a quarter for your BTW. For five invoices. Something about that doesn't add up." },
      ],
    },
    compare: {
    ...
    footer: {
      tagline: "Drop your invoices. {agent}.",
      madeBy: "Made by Gabz in Groningen, NL",
      linksH: "Links",
      legalH: "Legal",
      contact: "hello@{domain}",
      legal: ["Terms of Service", "Privacy Policy", "Cookie Policy", "Disclaimer"],
      soon: "Available at launch",
      barLeft: "© {year} {brand}. All rights reserved.",
      barRight: "{brand} · Not affiliated with Belastingdienst · Preview prototype",
  ...
  es: {
    ...
    builder: {
      ...
      sig: "— Gabz, zzp'er & maker",
      label: "Hecho por una persona en Países Bajos",
    },
    pain: {
      eyebrow: "El problema",
      ...
      cards: [
        { t: "Tiempo", d: "El portal de la Belastingdienst te cuesta una tarde si no conoces las reglas. No debería ser así." },
        { t: "Idioma", d: "El formulario está en neerlandés. Tus facturas, en inglés. Tus herramientas son americanas. Una de estas cosas no encaja con las demás." },
        { t: "No saber", d: "Reverse charge. Rubriek 4a. ICP opgaaf. Nadie te lo explica cuando registras tu KVK. Lo descubres cuando algo sale mal." },
        { t: "El miedo", d: "Una rubriek equivocada no es solo un error — es una carta de la Belastingdienst. La mayoría de los zzp'ers lo hacen bien. La mayoría no está segura de haberlo hecho." },
      ],
    ...
    audience: {
      ...
      h: "¿Te suena?",
      cards: [
        { d: "Usas Vercel, Anthropic, Linear. Todos tus gastos son facturas extranjeras sin BTW. No sabías que eso se llama 'reverse charge' — ni que el BTW lo tienes que declarar tú." },
        { d: "Vives en Países Bajos pero piensas en inglés (o en español). El portal de la Belastingdienst está en neerlandés. Cada trimestre abres Google Translate junto al formulario." },
        { d: "Lo apuntas todo en un Excel. Funciona, más o menos. Pero en cada aangifte te preguntas: ¿lo estaré haciendo bien?" },
        { d: "Tu gestor te cobra €200 al trimestre por el BTW. Por cinco facturas. Algo ahí no cuadra." },
      ],
    },
    compare: {
    ...
    footer: {
      tagline: "Sube tus facturas. {agent}.",
      madeBy: "Hecho por Gabz en Groningen, NL",
      linksH: "Links",
      legalH: "Legal",
      contact: "hello@{domain}",
      legal: ["Términos del servicio", "Política de privacidad", "Política de cookies", "Aviso legal"],
      soon: "Disponible en el lanzamiento",
      barLeft: "© {year} {brand}. Todos los derechos reservados.",
      barRight: "{brand} · No afiliado a la Belastingdienst · Prototipo de vista previa",
